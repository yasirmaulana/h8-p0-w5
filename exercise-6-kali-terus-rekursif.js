...
//         hasilKali *= parseInt(stringAngka[i])
//     }
//     stringAngka = hasilKali.toString()
//
//   }
//   return stringAngka
//
...
function kaliTerusRekursif(angka) {
  ...
  if(stringAngka.length === 1){
    ...
    // while (stringAngka.length >1) { ======> fungsi while dipindah jadi if diatas
      var hasilKali = 1
      for(var i=0; i<stringAngka.length; i++){
          hasilKali *= parseInt(stringAngka[i])
      }
      ...
      return kaliTerusRekursif(stringAngka)
